...
<div class="flex justify-center items-center h-full w-full flex-col">
  ...
  <h2 class="text-xl plg:text-3xl font-light text-center p-3">
    {@html new Text(homeJSON.doing).value}
  </h2>
  ...
  <div class="flex gap-4 mt-6 items-center">
    ...
    >
      <svg
        class="w-8 fill-egg group-hover:fill-egg/80 transition-all duration-300"
        viewBox="0 0 24 24"
  ...
  <div class="absolute bottom-2 left-0 w-full z-20">
    <Waves />
  </div>
</div>
